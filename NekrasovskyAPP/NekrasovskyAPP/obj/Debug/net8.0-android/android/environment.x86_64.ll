...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libInvertBytes.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
		i64 1295711804450587492, ; hash 0x11fb4b056b8ec364, from name: barhopper_v3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libbarhopper_v3.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"db157aa5-04d9-4468-ae85-4b2cd65685a4\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.companyname.nekrasovskyapp\00", align 16

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [18 x i8] c"libInvertBytes.so\00", align 16
@.DSOCacheEntry.1_name = private unnamed_addr constant [19 x i8] c"libbarhopper_v3.so\00", align 16
@.DSOCacheEntry.2_name = private unnamed_addr constant [23 x i8] c"libsurface_util_jni.so\00", align 16
@.DSOCacheEntry.3_name = private unnamed_addr constant [32 x i8] c"libimage_processing_util_jni.so\00", align 16
