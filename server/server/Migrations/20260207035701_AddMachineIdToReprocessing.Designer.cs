...
namespace server.Migrations
{
    ...
    [Migration("20260207035701_AddMachineIdToReprocessing")]
    partial class AddMachineIdToReprocessing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.FinishedGoodsRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("server.Models.ProductOutput", b =>
                {
                    ...
                    b.Property<int?>("RewindWarehouseId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DefectWarehouseId");

                    b.HasIndex("EcoWarehouseId");

                    b.HasIndex("NormalWarehouseId");

                    b.HasIndex("ProductBatchId");

                    b.HasIndex("ProductId");

                    b.HasIndex("RewindToUserId");

                    b.HasIndex("RewindWarehouseId");
            ...
            modelBuilder.Entity("server.Models.ProductOutput", b =>
                {
                    b.HasOne("server.Models.Warehouse", "DefectWarehouse")
                        .WithMany()
                        .HasForeignKey("DefectWarehouseId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("server.Models.Warehouse", "EcoWarehouse")
                        .WithMany()
                        .HasForeignKey("EcoWarehouseId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("server.Models.Warehouse", "NormalWarehouse")
                        .WithMany()
                        .HasForeignKey("NormalWarehouseId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("server.Models.User", "RewindToUser")
                        .WithMany()
                        .HasForeignKey("RewindToUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("server.Models.Warehouse", "RewindWarehouse")
                        .WithMany()
                        .HasForeignKey("RewindWarehouseId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("DefectWarehouse");

                    b.Navigation("EcoWarehouse");

                    b.Navigation("NormalWarehouse");

                    b.Navigation("Product");

                    b.Navigation("ProductBatch");

                    b.Navigation("RewindToUser");

                    b.Navigation("RewindWarehouse");
